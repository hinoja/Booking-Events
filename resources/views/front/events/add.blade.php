...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/create_venue_event.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jan 2024 06:57:05 GMT -->
									...
									<div class="table-responsive">
										<div
											...
											<div class="table-row table-head no-bg">
												<div class="table-col fs-14 text-light3">Price <span
														class="red">*</span></div>
												...
												<div class="table-col first-col">
													<div class="form-group m-0 form-custom-validation">
														<input class="form-control h_40" type="number" min="0"
															max="10000" required="" placeholder="Price" value="">
													</div>
												</div>
														...
														<div class="col-lg-12 col-md-12">
															<div class="form-group border_bottom pb_30">
																...
																<p class="mt-2 d-block fs-14 mb-3">See how your name
																	...
																	where your event name will be used. <a href="#"
															...
															<div class="form-group border_bottom pt_30 pb_30">
																...
																<p class="mt-2 d-block fs-14 mb-3">Choosing relevant
																	...
																	your event. <a href="#" class="a-link">Learn
																		more</a></p>
																<select class="selectpicker" multiple="" data-size="5"
															...
															<div class="form-group pt_30 pb_30">
																...
																<p class="mt-2 fs-14 d-block mb-3 pe_right">Upload
																	...
																	details page. <a href="#" class="a-link">Learn
																		more</a></p>
															...
															<div class="content-holder">
																...
																<div class="setting-item border_bottom pb_30 pt_30">
																	...
																	<div class="booking-end-time-holder"
																		style="display:none;">
																		<div class="form-group pt_30">
																			<label class="form-label fs-16">Booking ends
																				on</label>
																			<p class="mt-2 fs-14 d-block mb-0">Specify
																				the date and time when you want the
																				booking to start.</p>
																...
																<div class="setting-item border_bottom pb_30 pt_30">
																	<div class="d-flex align-items-start">
																		<label class="btn-switch m-0 me-3">
																			<input type="checkbox" class=""
																				id="passing-service-charge-btn" value=""
																				checked>
																			<span class="checkbox-slider"></span>
																		</label>
																		<div class="d-flex flex-column">
																...
																<div class="setting-item border_bottom pb_30 pt_30">
																	<div class="d-flex align-items-start">
																		...
																		<div class="d-flex flex-column">
																			<label class="color-black fw-bold mb-1">I do
																...
																<div class="setting-item border_bottom pb_30 pt_30">
																	<div class="d-flex align-items-start">
																		<label class="btn-switch m-0 me-3">
																			<input type="checkbox" class=""
																				id="ticket-instructions-btn" value=""
																				checked>
																			<span class="checkbox-slider"></span>
																		</label>
																		<div class="d-flex flex-column">
