                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12">
                                                                    ...
                                                                    <div class="content-holder mt-4">
                                                                        <div class="">
                                                                            <input type="file" name="image"
                                                                                ...
                                                                                {{-- placeholder="@lang('Add job specifications file')" --}}
                                                                ...
                                                                <div class="form-group border_bottom pb_30">
                                                                    ...
                                                                    {{-- <textarea wire::ignore wire.model="description" name="description"
                                                                        class="text-editor mt-4 @error('description') is-invalid @enderror" id="description">
                                                                    <div id="pd_editor">{{ $description }}</div>
                                                                </textarea> --}}
                                                                    <div wire:ignore class="col-12">
                                                                        <textarea  wire:model="description" {{-- id="summernote" class="card-body summernote" --}} class="form-control col-12" cols="10"
                                                                            rows="20">{{ $description }}</textarea>
                                                                    </div>
                                                                    @error('description')
                                                                        <span
                                                                            class="text-danger d-flex justify-content-start"><small>{{ $message }}</small></span>
