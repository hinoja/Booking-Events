                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-main-title">
                            <h3><i class="fa-solid fa-calendar-days me-3"></i>Liste des Evènements ({{ $count }})
                            </h3>
                        </div>
                    </div>
                    <div class="col-md-12">
                                            ...
                                            <div class="contact-list">
                                                ...
                                                <div
                                                    ...
                                                    <div class="icon-box">
                                                        ...
                                                        <p> Commence le </p>
                                                        <h6 class="coupon-status">{{ $event->formatDate($event->date) }} à
                                                            {{ $event->start_at }} </h6>
                                                    </div>
                                                    <div class="icon-box">
                                                        <span class="icon">
                                                        ...
                                                        <p>TYPE</p>
                                                        <h6 class="coupon-status">                                                            {{ $event->price== 1 ? 'GRATUIT' : 'PAYANT' }}
                                                        </h6>
                                                    </div>
                                                    <div class="icon-box">
                                                        <span class="icon">
